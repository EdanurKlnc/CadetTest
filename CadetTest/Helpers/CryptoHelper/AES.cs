...
namespace CadetTest.Helpers.CryptoHelper
{
    public class AES
    {
        ...
        private static string _salt = "0Palyac0Ben1mDem1s"; // Random
        ...
        private static byte[] GetBytes<T>(string str)
        {
        ...
        {
            if (value.Length <= 0) return string.Empty; //BITS.127047
